...
public class sym {
  ...
  static final int Else = 10;
  static final int ExpQ = 9;
  static final int FieldExpList = 15;
  static final int RFunDec = 23;
  static final int TyCast = 20;
  static final int Var = 3;
  static final int NextArg = 14;
  static final int Fld_Var = 5;
  static final int Opr_Exp = 1;
  static final int TyField = 21;
  static final int Args = 13;
  static final int FunDec = 22;
  static final int NFieldExpList = 16;
  static final int DecLst = 7;
  static final int If_Exp = 2;
  static final int NextSeq = 12;
  static final int Exp = 0;
  static final int RTyDec = 19;
  static final int TyDec = 18;
  static final int NTyField = 17;
  static final int Sub_Var = 4;
  static final int Seq = 11;
